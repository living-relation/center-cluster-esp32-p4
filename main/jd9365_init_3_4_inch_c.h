/*
 * jd9365_init_3_4_inch_c.h
 *
 * Panel-specific JD9365 initialization sequence for the Waveshare 3.4-inch
 * 800x800 round DSI LCD (variant "C", used on the ESP32-P4-WIFI6-Touch-LCD-3.4C
 * board). Copied verbatim from the official Waveshare BSP:
 *   waveshareteam/Waveshare-ESP32-components/bsp/esp32_p4_wifi6_touch_lcd_xc
 *   (esp32_p4_wifi6_touch_lcd_xc.c, CONFIG_BSP_LCD_TYPE_800_800_3_4_INCH branch)
 *
 * The default init sequence inside espressif/esp_lcd_jd9365 targets the
 * 800x1280 panel and does NOT bring up this round 3.4" panel correctly
 * (display stays blank). This array must be passed via jd9365_vendor_config_t.
 *
 * Apache-2.0, (c) Waveshare / Espressif.
 */
#pragma once

#include "esp_lcd_jd9365.h"

static const jd9365_lcd_init_cmd_t jd9365_3_4_inch_c_init_cmds[] = {
